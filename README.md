...
A server-authoritative NeoForge mod for Minecraft 26.2. Permitted players can inspect, create, remove, restore, and hide recipes without leaving the game. Recipe changes are stored with the world and reapplied whenever recipes reload.
