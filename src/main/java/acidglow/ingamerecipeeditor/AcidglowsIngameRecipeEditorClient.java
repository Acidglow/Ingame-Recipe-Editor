...
public class AcidglowsIngameRecipeEditorClient {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        AcidglowsIngameRecipeEditor.LOGGER.info("HELLO FROM CLIENT SETUP");
        AcidglowsIngameRecipeEditor.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}
